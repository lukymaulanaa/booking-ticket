...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- Date Picker -->
  <link rel="stylesheet" href="assets/template/css/bootstrap-datepicker.min.css">
  <!-- CS Select -->
  <link rel="stylesheet" href="assets/template/css/cs-select.css">
  <link rel="stylesheet" href="assets/template/css/cs-skin-border.css">
  ...
  <body>
        ...
        <div class="nav-header">
          ...
          <nav id="fh5co-menu-wrap" role="navigation">
            <ul class="sf-menu" id="fh5co-primary-menu">
              ...
              <li><a href="<?php echo base_url() ?>assets/template/contact.html">Contact</a></li>
              <li><a href="<?php echo base_url() ?>"></li>
            </ul>
          </nav>
        </div>
      </div>
    ...
    <div class="fh5co-hero">
      ...
      <div class="fh5co-cover" data-stellar-background-ratio="0.5" style="background-image: url(assets/template/images/flight.jpg);">
        <div class="desc">
          <div class="container">
            <div class="row">
    ...
    <div id="fh5co-tours" class="fh5co-section-gray">
      <div class="container">
        ...
        <div class="row row-bottom-padded-md">
          ...
          <div class="col-md-6 animate-box">
            <img class="img-responsive" src="assets/template/images/cover_bg_3.jpg" alt="travel">
        ...
        <div class="row row-bottom-padded-md">
          <div class="col-md-4 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
            <div href="#"><img src="assets/template/images/place-1.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
              <div class="desc">
                <span></span>
                <h3>New York</h3>
                <span>3 nights</span>
          ...
          <div class="col-md-4 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
            <div href="#"><img src="assets/template/images/place-2.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
              <div class="desc">
                <span></span>
                <h3>Philippines</h3>
                <span>4 nights</span>
          ...
          <div class="col-md-4 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
            <div href="#"><img src="assets/template/images/place-3.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
              <div class="desc">
                <span></span>
                <h3>Hongkong</h3>
                <span>2 nights</span>
          ...
          <div class="col-md-4 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
            <div href="#"><img src="assets/template/images/place-4.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
              <div class="desc">
                <span></span>
                <h3>New York</h3>
                <span>3 nights</span>
          ...
          <div class="col-md-4 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
            <div href="#"><img src="assets/template/images/place-5.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
              <div class="desc">
                <span></span>
                <h3>Philippines</h3>
                <span>4 nights</span>
          ...
          <div class="col-md-4 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
            <div href="#"><img src="assets/template/images/place-6.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
              <div class="desc">
                <span></span>
                <h3>Hongkong</h3>
                <span>2 nights</span>

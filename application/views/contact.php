...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	<!-- Animate.css -->
	<link rel="stylesheet" href="asstes/template/css/animate.css">
	<!-- Icomoon Icon Fonts-->
	<link rel="stylesheet" href="asstes/template/css/icomoon.css">
	<!-- Bootstrap  -->
	<link rel="stylesheet" href="asstes/template/css/bootstrap.css">
	<!-- Superfish -->
	<link rel="stylesheet" href="asstes/template/css/superfish.css">
	<!-- Magnific Popup -->
	<link rel="stylesheet" href="asstes/template/css/magnific-popup.css">
	<!-- Date Picker -->
	<link rel="stylesheet" href="asstes/template/css/bootstrap-datepicker.min.css">
	<!-- CS Select -->
	<link rel="stylesheet" href="asstes/template/css/cs-select.css">
	<link rel="stylesheet" href="asstes/template/css/cs-skin-border.css">
	
	<link rel="stylesheet" href="asstes/template/css/style.css">


	<!-- Modernizr JS -->
	<script src="asstes/template/js/modernizr-2.6.2.min.js"></script>
	<!-- FOR IE9 below -->
	<!--[if lt IE 9]>
	...
	<body>
				...
				<div class="nav-header">
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							<li><a href="asstes/template/flight.html">Flights</a></li>
		...
		<div class="fh5co-hero">
			...
			<div class="fh5co-cover" data-stellar-background-ratio="0.5" style="background-image: url(assets/template/images/cover_bg_1.jpg);">
				<div class="desc">
					<div class="container">
						<div class="row">
	...
	<script src="assets/template/js/google_map.js"></script>
